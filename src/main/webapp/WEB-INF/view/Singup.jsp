...
#formlogin {
	...
	<form action="/PH14249/register" method="POST" style="position: absolute; top: 20%; right: 65%;">
		<div class="login-form" id="formlogin">
			<h1>Sing Up</h1>
			<br>
			<div class="form-group ">
				<input type="text" class="form-control" placeholder="Full Name"
					name="fullname"> <i class="mdi mdi-account"></i>
			</div>
			<div class="form-group ">
				<input type="text" class="form-control" placeholder="User"
					name="username"> <i class="mdi mdi-account"></i>
			</div>
			<div class="form-group log-status">
				<input type="password" class="form-control" placeholder="Password"
					name="password1"> <i class="mdi mdi-lock"></i>
			</div>
			<div class="form-group log-status">
				<input type="password" class="form-control" placeholder="enter Password"
					name="password2"> <i class="mdi mdi-lock"></i>
			</div>
			<label>${thongbao}</label>
			<span class="alert"></span> <a class="link"
				href="/PH14249/login">Đăng Nhập</a>
